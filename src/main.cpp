...
//#pragma omp parallel for 
    ...
    get_init_t0s(t0s,fill_step*Trf,Trf/2,Trev,nBeam,nBunch,beam_shift,h[0],1,1*t_hat/2.0);
    get_init_gamma0s(gamma0s,t0s,fill_step*Trf,Trf/2,Trev,Gamma0, nBeam,nBunch,beam_shift,h[0],1,5);
    srand(0);
